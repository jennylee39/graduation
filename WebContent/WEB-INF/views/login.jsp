...
<body>
	...
	<div class="container" style="width: 70%; margin: auto;">
		...
		<div class="tabbable">
			...
			<ul class="nav nav-tabs" style="width: 40%; margin: auto;">
				<li class="nav-item active" style="width: 50%; font-size: 12px;"><a
					class="nav-link active" href="#tab1" data-toggle="tab">학생 로그인</a></li>
				<li class="nav-item" style="width: 50%; font-size: 12px;"><a
					class="nav-link" href="#tab2" data-toggle="tab">관리자 로그인</a></li>
			</ul>
			<br>
			<div class="tab-content">
				<div class="tab-pane active" id="tab1">
					<form class="login" id="loginForm" style="margin: auto;"
						action="loginCheck" method="post">

<br>
						<div style="margin: 0px auto; width: 50%;">

							<br> <input id="user_id" name="user_id" type="text"
								class="loginInput" placeholder="ID" /><br> <input
								id="user_pwd" name="user_pwd" type="password" class="loginInput"
								placeholder="PASSWORD" /><br> <br> <input
								type="submit" class="loginButton" id="loginButton"
								value="LOG IN"></input> <BR> <BR><br> <span>회원이
								아니십니까? <a href="signupCheck1">Sign UP</a>
							</span>
						</div>
					</form>
				</div>
				<div class="tab-pane" id="tab2">
					<form class="login" id="loginForm" style="margin: auto;"
						action="loginCheck2" method="post">
						...
						<div class="container" style="width: 70%; margin: auto;">
							<div style="margin: 0px auto; width: 50%;">
								...
								<br> <input id="admin_id" name="admin_id" type="text"
									class="loginInput" placeholder="ID" /><br> <input
									id="admin_pwd" name="admin_pwd" type="password"
									class="loginInput" placeholder="PASSWORD" /><br> <br>
								<input type="submit" class="loginButton" id="loginButton"
									value="LOG IN"></input> <BR> <BR><br> <span>회원이
									아니십니까? <a href="signupCheck2">Sign UP</a>
								</span>
							</div>
