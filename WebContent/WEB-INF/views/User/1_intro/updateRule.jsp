...
<body>
	...
	<div id="body_current" align="center">
		...
		<div style="width: 70%;">
			...
			<form id="rule" method="post" name="rule"
				onsubmit="return checkValue()"
				action="updateRule?id=${detailRule.id}">
					...
					<tbody>
						<tr>
							<td><input name="id"
								...
								value="${detailRule.id}"></td>
							<td><input name="content"
								style="width: 100%; background-color: #f5f5f5;"
								value="${detailRule.content}"></td>
							<td><input name="minus"
								style="width: 100%; background-color: #f5f5f5;"
								value="${detailRule.minus}"></td>
							<td><input name="refer"
								style="width: 100%; background-color: #f5f5f5;"
								value="${detailRule.refer}"></td>
							<td><input class="add-button"
								style="float: right; width: 100%;" name="add" type="submit"
								onsubmit="return checkValue()" value="확인"></td>
						</tr>
						<c:forEach items="${ruleList}" var="ruleList">
							<tr>
								...
								<td><input class="add-button"
									style="background-color: #91a8d0; float: right; width: 100%;"
									name="update" type="submit" value="수정 불가 " readonly></tr>
			...
			<br>
					<input type="button" class="add-button" style="float: right;"
						onclick="location.href='addRule';" value="완료">
