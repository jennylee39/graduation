...
<body>
	...
	<!-- body -->
	<div id="body_intro" align=center>
		<br>
		<h1>인사말</h1>
		<br>
		<hr style="width: 60%;">
		...
		<div class="row" style="width:65%;">
			...
			<img src="http://ujstu1.godohosting.com/g5/data/editor/1705/d866887ca7724cccc3d0f5dd24d932c1_1495690062_906.jpg" width=80%><br> <br></div>
		<div class="col-md-6 mr-2" style="font-size: 17px; border:1px solid #ccc;">
			<br>안녕하십니까? <br> 학사장 장현정입니다. <br> <br>
			<h3>Global 울진 인재들의 요람 ! 울진학사</h3>
			<br> 울진군민의 오랜 숙원이던 울진학사는<br> 학부모들의 학비부담을 덜어주고<br> 자녀들의
			안심하고 학업에 전념할 수 있는 여건과<br> 주거 편의를 제공하기 위하여<br> 1인 1실 140명을
			수용할 수 있는 규모로<br> 교육 1번지 서울특별시 동대문구에 둥지를 틀었습니다.<br> <br>
			<br>
			<h4>우리학사는 「Global 울진 인재들의 요람 !」</h4>
			이 슬로건으로 울진의 영재들이 <br> 서로를 존중하고 배려하면서<br> 꿈을 향한 열정적인 노력과
			도전으로<br> 글로벌 무대로 당당하게 진출할 수 있도록 지원하고,<br> 안전하고 편안한 휴식과 학업
			증진의 공간으로<br> 만들어 나아갈 것을 약속 드리며<br> 저와 사감선생님들은 사명감으로 그 책무를 다
			하겠습니다.<br> <br> 벌써 개관 3년차 입사생을 맞이하였습니다.<br> 그동안 우리학사
			개관과 발전을 위하여<br> 성원해주신 모든 분들께 진심으로 감사드리며,<br> 앞으로 우리학사가 더욱더
			발전할 수 있도록<br> 많은 관심과 조언을 당부드립니다.<br> <br> 
			<img src="img/uj_sign.jpg" width=40%>
		</div>
		</div>
