...
<body>
	...
	<div id="body_current" align="center">
		...
		<div class="container" style="width: 70%; margin: auto;">
			...
			<button class="add-button" onclick="location.href='addNotice';"
					...
					<c:forEach items="${noticeList}" var="noticeList">
						<tr>
							<td>${noticeList.bno}</td>
									...
									<td><a href="detailNotice?bno=${noticeList.bno}">${noticeList.title}</a></td>
								
							<td>${noticeList.writer}</td>
							<td><fmt:formatDate value="${noticeList.addDate}"
