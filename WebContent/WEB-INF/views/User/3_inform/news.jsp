...
<body>
	...
	<div id="body_current" align="center">
		...
		<div class="container" style="width: 70%; margin: auto;">
			...
			<button class="add-button" onclick="location.href='addNews';"
				...
				<tbody>
					<c:forEach items="${newsList}" var="newsList">
						<tr>
							...
							<td><a href="detailNews?bno=${newsList.bno}">${newsList.title}</a></td>

							<td>${newsList.writer}</td>
							<td><fmt:formatDate value="${newsList.addDate}"
									timeZone="Asia/Seoul" pattern="yyyy/MM/dd"></fmt:formatDate></td>
							<td><c:out value="${newsList.count}"></c:out></td>
						</tr>
