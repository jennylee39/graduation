...
<body>
	...
	<div id="body_current" align="center">
		...
		<div class="container" style="width: 70%; margin: auto;">
			<c:if test="${sessionScope.role eq '관리자' }">
				<button class="add-button" onclick="location.href='addGallery';"
			 ...
			 <div class="row">
				...
				<c:forEach items="${galleryList}" var="galleryList">
					...
					<div class="col-md-3 col-sm-6">
						...
						<a href="detailGallery?bno=${galleryList.bno}"
								style="font-weight: bold; color: #5B5B5B;">
						<c:url value="/gallery\\${galleryList.orgname1}" var="url1" />
						<img id="load" src="${url1}" /> <br></a>
						</div>
						<div class="content" style="width:240px; height:115px; margin-top:5px; margin-bottom:7px;border:1px solid #dcdcdc;">
						<br>
						<a href="detailGallery?bno=${galleryList.bno}"
								style="font-weight: bold; color: #5B5B5B;">
							<h4>${galleryList.title}</h4></a>
							<br> <span style="float: left; margin-left:5px; margin-bottom:3px;">${galleryList.writer}</span>
							<span style="float: right; margin-right:5px; margin-bottom:3px;"><fmt:formatDate value="${galleryList.addDate}"
									timeZone="Asia/Seoul" pattern="yy/MM/dd"></fmt:formatDate></span> <br> <br> <br>
						</div>
	...
	<script>
		...
		function fn_prev(page, range, rangeSize) {
			...
			var range = range - 1;
			var url = "${pageContext.request.contextPath}/gallery";
