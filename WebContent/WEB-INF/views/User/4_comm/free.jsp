...
<body>
	...
	<div class="container" style="width: 70%; margin: auto;">
		<%
			if (id != null) {
		%>
		<button class="add-button" onclick="location.href='addFree';"
			...
			<tbody>
				<c:forEach items="${freeList}" var="freeList">
					<tr>
						...
						<td><a href="detailFree?bno=${freeList.bno}">${freeList.title}</a></td>

						<td>${freeList.writer}</td>
						<td><fmt:formatDate value="${freeList.addDate}"
								timeZone="Asia/Seoul" pattern="yyyy/MM/dd"></fmt:formatDate></td>
						<td>${freeList.count}</td>
					</tr>
	...
	<script>
		...
		function fn_prev(page, range, rangeSize) {
			...
			var range = range - 1;
			var url = "${pageContext.request.contextPath}/free";
