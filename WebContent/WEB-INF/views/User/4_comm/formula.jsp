...
<br>
	...
	<hr style="width: 70%;">
		...
		<div class="container" style="width: 70%; margin: auto;">
			...
			<button class="add-button" onclick="location.href='addFormula';"
			...
			style="margin: auto; text-align: left;">
				<thead>
					<tr style="border-top: 2px solid #ccc;">
						...
						<th style="width: 11%;">글쓴이</th>
						<th style="width: 13%;">날짜</th>
						<th style="width: 7%;">조회</th>
					</tr>
				</thead>
				<tbody>
					<c:forEach items="${formulaList}" var="formulaList">
						<tr>
							<td>${formulaList.bno}</td>
							
									<td><a href="detailFormula?bno=${formulaList.bno}">${formulaList.title}</a></td>
								
							<td>${formulaList.writer}</td>
							<td><fmt:formatDate value="${formulaList.addDate}"
									timeZone="Asia/Seoul" pattern="yyyy/MM/dd"></fmt:formatDate></td>
							<td>${formulaList.count}</td>
						</tr>
