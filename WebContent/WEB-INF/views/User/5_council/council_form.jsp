...
<body>
	...
	<div id="body_current" align="center">
		...
		<div class="container" style="width: 70%; text-align: center;">
			<div>
				<p
					style="text-align: left; color: orange; font-weight: bold; font-size: 18px;">구성</p>
				<p style="text-align: left;">회장, 부회장( 남,녀 각 1명 ), 홍보부장, 총무, 각 층장
					(총 16명)</p>
				<c:choose>
					<c:when test="${sessionScope.role eq '관리자'}">
						<input type="button" class="add-button" style="float: right;"
							onclick="location.href='addCouncil';" value="수정">
						<br>
					</c:when>
			...
			<table class="table table-bordered table-striped" id="rule"
				...
				<thead>
					<tr style="border-top: 2px solid #ccc;">
						<th style="text-align: center; width: 40%;">직책</th>
						<th style="text-align: center; width: 30%;">이름</th>
						<th style="text-align: center; width: 30%;">학년</th>
					</tr>
				</thead>
				<tbody>
