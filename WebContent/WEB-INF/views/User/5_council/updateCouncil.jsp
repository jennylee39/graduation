	...
	<div id="body_current" align="center">
		...
		<div style="width: 70%;">
			...
			<form id="rule" method="post" name="rule"
				...
				action="updateCouncil?id=${detailCouncil.id}">
					...
					<tbody>
						<tr>
							<td><input name="id"
								...
								value="${detailCouncil.id}"></td>
							<td><input name="role"
								style="width: 100%; background-color: #f5f5f5;"
								value="${detailCouncil.role}"></td>
							<td><input name="name"
								style="width: 100%; background-color: #f5f5f5;"
								value="${detailCouncil.name}"></td>
							<td><input name="grade"
								style="width: 100%; background-color: #f5f5f5;"
								value="${detailCouncil.grade}"></td>
						...
						<c:forEach items="${councilList}" var="councilList">
							<tr>
								...
								<td><input class="add-button"
									style="background-color: #91a8d0;float: right; width:100%;" name="update" type="submit"
									value="수정 불가 " readonly> 
			...
			<c:choose>
				<c:when test="${sessionScope.role eq '관리자'}">
					<input type="button" class="add-button" style="float: right;"
						onclick="location.href='addCouncil';" value="완료">
				</c:when>
			</c:choose>
		</div>
	</div>
