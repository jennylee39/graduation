...
<body>
	...
	<h4>글쓰기</h4><br>
	<hr style="width: 60%;">
	<form class="form" id="news" method="post" name="news"
		onsubmit="return checkValue()" action="addNews"
	...
	<footer
		...
		function checkValue() {
			...
			if(document.news.rink1.value==rink1Check){
				alert("링크 #1을 제대로 입력하세요.");
				return false;
			}
			if(document.news.rink2.value==rink2Check){
