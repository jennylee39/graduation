...
<br>
	...
	<h3>글쓰기</h3><br>
	<hr style="width: 60%;">
	<form class="form" id="free" method="post" name="free"
		onsubmit="return checkValue()" action="addFree"
		...
		<table class="type" style="margin: auto; align: center; width: 70%;">
			...
			<tr>
				<th id="title">파일 선택 #5</th>
				<td><input type="file" name="file5" id="upload5" />
					<div id='preview5' >
						<!-- 미리보기 공간 -->
					</div></td>
			</tr>
	...
	<footer
		...
		function checkValue() {
			...
			if(document.free.rink1.value==rink1Check){
				alert("링크 #1을 제대로 입력하세요.");
				return false;
			}
			if(document.free.rink2.value==rink2Check){
    ...
    upload1.addEventListener('change',function (e) {
		...
		var upload5 = document.querySelector('#upload5');
